...
describe('Reviewer Avatar URLs', () => {
  ...
  const reviewerAvatars: { [key: string]: string } = {
    ...
    'ai-for-marketing-professionals-Jennifer Liu': 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=100&h=100&fit=crop&crop=face&auto=format&q=80',
