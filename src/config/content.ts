...
const zhContent: Content = {
  ...
  whyJoin: {
    ...
    title: "為何加入 AI Jedi",
    subtitle: "賦能下一代專業人士在 AI 時代蓬勃發展",
    mainText: [
      "你不需要電腦科學學位就能開始在工作中使用 AI。透過當今強大的無程式碼 AI 工具，你可以自動化任務、簡化工作流程並創造新機會——即使沒有技術背景。只要能描述你想要的，就能實現。",
      "但這裡有你在其他地方找不到的：本課程建立在近三十年來在財富 200 強公司和被收購新創公司的真實 AI 實施經驗之上。每個範例、每個工作流程、每個策略都來自實際的商業戰場——而非理論課堂情境。",
      "這個實作課程專為想要透過應用真正有效的 AI 來提升職涯的非技術專業人士設計。零被動學習。你將從第一天起就使用經過實戰考驗的框架進行建構，使用在大型企業推動數百萬收入和營運節省的完全相同方法。",
      "在短短一個週末內，你將設計並實施可以立即在工作或業務中部署的 AI 工作流程——這些工作流程已在高風險企業環境中得到驗證。我們將使用經受住財富 200 強董事會和新創擴展挑戰考驗的無程式碼工具和前沿 AI 實務，逐步指導你。",
      "重點是：你不只是在學習 AI——你學習的是在真實世界中鍛造出來的 AI，並且已被證明能在最重要的地方交付成果。"
    ],
    features: [
      {
        icon: "🚀",
        title: "以做中學",
        description: "透過將 AI 應用於日常工作挑戰獲得真實世界經驗。"
      },
      {
        icon: "🤖",
        title: "AI 優先工作流程",
        description: "掌握最新的無程式碼 AI 工具，用於文字、圖像、影片和數據——無需程式設計。"
      },
      {
        icon: "💡",
        title: "快速交付成果",
        description: "設計並啟動一個你可以在課程結束時帶回工作崗位的 AI 工作流程。"
      }
    ],
    cta: "探索線上課程"
  },
