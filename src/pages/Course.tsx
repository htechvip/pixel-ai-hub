              ...
              <CardContent>
                <div className="space-y-6">
                  {courseData.reviews?.map((review, index) => {
                    // Course-aware unique avatar assignment for all reviewers
                    const getAvatarUrl = (name: string) => {
                      // Create a unique key combining course ID and reviewer name to handle duplicates
                      const uniqueKey = `${courseId}-${name}`;
                      
                      // Comprehensive mapping of course-reviewer combinations to unique avatars
                      ...
                      return reviewerAvatars[uniqueKey] || 'https://images.unsplash.com/photo-1566492031773-4f4e44671d66?w=100&h=100&fit=crop&crop=face&auto=format&q=80'; // fallback
                    };
